...
不过，我们定投的不是某只个股，而是 **ETF（Exchange-Traded Fund，交易所交易基金）**。你可以把 ETF 理解成一份“指数套餐”。我们选择的是沪深 300ETF（代码 510300），它把 A 股市场上规模最大的 300 家公司打包在一起——银行、白酒、新能源、互联网，各行各业的龙头都在里面。你买一份 ETF，就等于同时持有了这 300 家公司的股票，不需要你自己去挑选哪家公司好、哪家公司差。
...
> **任务**：在当前工作目录创建 `q1-strategy.ipynb`，获取沪深 300ETF（510300.SS）最近 5 年的历史日线数据并可视化。
>
> 📌 **要点**：关键事物要点名到 ID。“沪深 300”不够——A 股有沪深 300 指数（000300.SH）也有跟踪它的 ETF（510300.SS、510310.SS、510330.SS），AI 不知道你想要哪个。spec 里所有关键名词都要具体到不能再具体。
